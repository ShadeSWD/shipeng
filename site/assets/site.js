  ...
  <svg width="30" height="30" viewBox="0 0 30 30" aria-hidden="true">
    ...
    nav: [
      ...
      { t: 'Теория', h: 'theory', drop: [
        ...
        { h: 't-operation', k: 'theory', t: '9. Эксплуатация установки' },
      ] },
      { t: 'Задачи', h: 'tasks', drop: [
        ...
        { h: 'p-propeller', k: 'tasks', t: '5. Проектирование гребного винта' },
        ...
        { h: 'p-recovery', k: 'tasks', t: '12. Утилизация тепла' },
        { h: 'p-start', k: 'tasks', t: '13. Пуск и реверс' },
        { h: 'p-torsion', k: 'tasks', t: '14. Крутильные колебания валопровода' },
      ] },
